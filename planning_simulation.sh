...
--tab --title "rosbag" -e 'bash -c "sleep 10; rosparam set use_sim_time false; sleep 1; rosbag play ../bags/2023-02-02/DY.bag --topics /localization/estimation /perception/local_grid_map/compressed /perception/freespace_grid_map/compressed /e100/speed_feedback /e100/steer_feedback /imu/angular_velocity -l; exec bash;"' \
