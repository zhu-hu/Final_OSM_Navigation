...
WGS84Elipsoid::WGS84Elipsoid(double bearing)
    : CoordinatesConverterBase(bearing) {}

double WGS84Elipsoid::getDistance(double latitude1, double longitude1,
...
double WGS84Elipsoid::getBearing(double latitude1, double longitude1,
                                 double latitude2, double longitude2) {
  geometry_msgs::Point p1 = getGeoPoint(latitude1, longitude1);
  geometry_msgs::Point p2 = getGeoPoint(latitude2, longitude2);
...
geometry_msgs::Point WGS84Elipsoid::getGeoPoint(double latitude,
                                                double longitude) {
